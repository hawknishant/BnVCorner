      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/80 border-b">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/images/logo.png" alt="BnV Corner Logo" className="h-12 w-auto" />
            <div>
          ...
          <a href="#contact" className="hidden md:inline-flex rounded-2xl px-4 py-2 bg-orange-600 text-white hover:bg-orange-700 shadow">Order / Enquire</a>
        </div>
      </header>
          ...
          {/* Additional Info */}
             <div className="mt-8 text-center">
               ...
               <div className="mt-4 flex justify-center gap-4">
                 <a href="mailto:bnvcorner@gmail.com" className="inline-flex items-center gap-2 px-4 py-2 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-6">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/bnv_corner/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-orange-600 transition">
              ...
              <a href="https://www.facebook.com/profile.php?id=61579945761174" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-orange-600 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://wa.me/918961618111" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-orange-600 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
